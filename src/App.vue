<template>
  <div id="app">
    ...
    <!-- Main -->
    <MainMain :faculties-slider-items="facultiesSliderItems" :events-items="eventsItems" :courses-items="coursesItems"
      :infos-items="infosItems" />
    <!-- Footer -->
